...
public class TestsPart2 {
	...
	public void testAdjacencyDoorways() {
		...
		testList = board.getAdjList(17, 31);
		Assert.assertTrue(testList.contains(board.getCellAt(18, 31)));
		Assert.assertTrue(testList.contains(board.getCellAt(16, 31)));
		Assert.assertTrue(testList.contains(board.getCellAt(17, 30)));
		Assert.assertEquals(3, testList.size());
	}
	...
	public void testTargetsTwoSteps() {
		...
		Assert.assertTrue(targets.contains(board.getCellAt(31, 9)));
	...
	public void testRoomExit() {
		...
		//walkway next to room
		board.calcTargets(18, 22, 2);
		targets= board.getTargets();
		Assert.assertEquals(3, targets.size());
		Assert.assertTrue(targets.contains(board.getCellAt(18, 20)));
		Assert.assertTrue(targets.contains(board.getCellAt(17, 21)));	
		Assert.assertTrue(targets.contains(board.getCellAt(19,21)));	
	}
